...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            # FCA module: takes input from two layers (P2 and P3)
            # Constructor: __init__(c1, c2, c3=None) where c1=P2_ch, c2=P3_ch, c3=output_ch
            c1_p2, c2_p3 = ch[f[0]], ch[f[1]]  # P2 and P3 input channels
            c3_out = args[0] if args else c1_p2  # output channels
            args = [c1_p2, c2_p3, c3_out]
            c2 = c3_out  # IMPORTANT: c2 tracks OUTPUT channels for next layer
